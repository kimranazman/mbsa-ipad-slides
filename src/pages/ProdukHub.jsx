...
const products = [
  ...
  },
  {
    id: 'mymr',
    name: 'MyMR',
    full: 'Pemudahcara Permit Kerja Kecil',
    origin: 'MP Sepang',
    expanded: 'MPKL, MP Selayang, MPHS',
    Icon: IconPeople,
    gold: true,
  },
  {
    id: 'abt',
    name: 'ABT Tracker',
    full: 'Pengesan Akaun Belum Terima Cukai Tanah',
    origin: 'PDT Petaling',
